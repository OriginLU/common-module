...
import com.charleslu.common.entity.TenantDataSourceDetail;
import com.charleslu.common.entity.TenantDataSourceWrapperDTO;
import com.charleslu.common.errors.CommonException;
import com.charleslu.common.errors.ErrorCode;
import com.charleslu.common.util.IPUtil;
import com.charleslu.tenancy.config.properties.LocalDataSourceProperties;
...
import static com.charleslu.tenancy.config.properties.TenantConfigProperties.DEFAULT_HEADERS;
import static com.charleslu.tenancy.config.properties.TenantConfigProperties.DEFAULT_REQUEST;
import static com.charleslu.tenancy.constants.TenantRemote.UaaMethods.*;
...
public class TenantDataSourceService {
    ...
    public void addDataSource(DataSourceInfo dataSourceInfo) {
        ...
        if (BooleanUtils.isNotTrue(dataSourceInfo.getNeedOverride()) && null != TenantDataSourceProvider.getTenantDataSource(dataSourceInfo.getTenantCode())) {
            throw new IllegalStateException("数据源已经初始化");
        }
    ...
    public Boolean checkDataSource(String tenantCode, String type) {
        ...
        return null != TenantDataSourceProvider.getTenantDataSource(tenantCode);
    }
